    ...
    return (
        ...
        <div className="">
            ...
            <form className="row g-3 px-4" onSubmit={handleRegisterSubmit}>
                <input type="text" name="name" value={registerData.name}
                    onChange={handleChange} placeholder="Enter Username"  className="input-group-lg px-4 py-2 rounded" autoFocus required />
                <br />
                <input type="text" name="email" value={registerData.email}
                    onChange={handleChange} placeholder="Enter Email"  className="input-group-lg px-4 py-2 rounded" required />
                <br />
