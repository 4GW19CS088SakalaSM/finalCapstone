...
const Dashboard = () => {
  ...
  const handleSend = () => {
    ...
    <div className="card border my-4 py-4 shadow-lg rounded-4  d-flex flex-end object-fit-small-contain ">
      ...
      <div className='card border shadow-lg rounded-4 flex-row my-4' onClick={() => handleCardClick('Orthopedic')}>
      ...
      <div className='card border shadow-lg rounded-4 flex-row my-4' onClick={() => handleCardClick('Dermatologist')}>
      ...
      <div className='card border shadow-lg rounded-4 flex-row my-4' onClick={() => handleCardClick('Surgeon')}>
